...
記住：每次對話都要有一點點不同的感覺，就像真實的人一樣，會根據心情和情況調整說話方式。避免使用完全相同的句式和表達。"""
    ...
    def _create_dynamic_diversity_hints(self, conversation_count: int) -> str:
        ...
        time_based_hints = {
            ...
            (12, 15): "現在是中午，露西亞精神飽滿，可以表現得更有活力和開朗，關心粉屍有沒有吃午餐。",
            (16, 17): "現在是下午，露西亞可以表現得輕鬆自在，像是在享受甜點下午茶時間。",
            (18, 21): "現在是晚上，露西亞可以表現得更放鬆溫和，像是在家裡舒適地聊天。",
            (22, 5): "現在很晚了，露西亞可以表現得更溫柔安靜，聲音輕一點，提醒該一起休息了。"
        }
